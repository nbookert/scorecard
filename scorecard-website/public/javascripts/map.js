function map() {
    ...
    // Load in states with HBCUs!
    let csv = d3.csv("/data/stateslocated.csv", function (data) {
            ...
            svg.selectAll("circle")
                ...
                .on("mouseout", function (d) {
                    ...
                    d3.json(url, function (data) {
                        ...
                        console.log("Indexing place of first line", data[0].NAME)
