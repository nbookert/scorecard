    ...
    MongoClient.connect("mongodb+srv://comp895va:dnjn895@hbcu-scoreboard-sjn7a.mongodb.net", function(err, client){
        ...
        db.collection('academicyear20182019', function(err, collection) {
            collection.find({},{projection: {ADM_RATE: 1, ACTCMMID: 1, UGDS: 1, LATITUDE: 1, LONGITUDE: 1, C150_4: 1, TUITIONFEE_IN: 1,
                ...
                let totalValues = {ACT_AVG: 0, ADM_RATE: 0, GRAD_RATE: 0, SAT_AVG: 0, TUITIONFEE_IN: 0, TUITIONFEE_OUT: 0, ENROLL: 0, SCORE: 0};
                let participantInst = {ACT_AVG: 0, ADM_RATE: 0, GRAD_RATE: 0, SAT_AVG: 0, TUITIONFEE_IN: 0, TUITIONFEE_OUT: 0, ENROLL: 0, SCORE: 0};
